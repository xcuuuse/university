...
Namespace MISamples
    Public Class Controller
        ...
        Private Const STR_APP_DOCK_INFO_NODE As String = "NamedViewDockPosInfo"
        '' file with path for docking persistence
        Private sDockInfoXMLFile As String = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\MapInfo\\MapInfo\\Professional\\" + InteropHelper.GetAppVersion() + "\\nviews_dockinfo.xml"

        Private Shared _namedViewDlg As NViewDlg = Nothing     '' Named View dialog
        ...
        Private Const controllerMutexName As String = "MISamples.NamedViewwDockController" '' Name of the mutex
        ...
        Public Shared Function ShowAboutDlg(ByVal hMainWnd As Integer) As Boolean
            Dim abtNViewDlg As New AboutNViewDlg()
        ...
        ''' <param name="hMainWnd"></param>
        ''' <returns></returns>
        Public Shared Function ShowNViewDlg(ByVal hMainWnd As Integer) As Boolean
            If _namedViewDlg Is Nothing Then
        ...
        ''' </summary>
        Public Shared Function CloseNViewDlg() As Boolean
            If _namedViewDlg IsNot Nothing Then
